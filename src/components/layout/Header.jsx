...
export default function Header() {
  ...
  const carCategories = [
    {
      title: "لوازم مصرفی",
      icon: <SprayCan className="w-4 h-4 sm:w-5 sm:h-5 text-blue-400" />,
      items: [
        "روغن موتور",
        "فیلتر روغن و هوا",
        "لنت ترمز",
    ...
    {
      title: "برق و انژکتور",
      icon: <Battery className="w-4 h-4 sm:w-5 sm:h-5 text-yellow-400" />,
      items: [
        "باتری خودرو",
        "دینام و استارت",
        "سنسور اکسیژن",
    ...
    },
    {
      ...
      icon: <Disc className="w-4 h-4 sm:w-5 sm:h-5 text-purple-400" />,
      items: [
        "کفپوش سه بعدی",
        "روکش صندلی",
        "ضبط و باند",
            ...
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              ...
              >
                <nav className="flex flex-col gap-4 sm:gap-6 mt-8">
                  <a
                    href="#"
                    className="text-base sm:text-lg hover:text-blue-400 transition-colors duration-300 py-2"
                  >
                    صفحه اصلی
                  </a>
                  ...
                  <Button
                    ...
                    className="bg-transparent border-2 border-gray-600 hover:bg-white/10 hover:border-blue-400 text-white justify-start gap-3 h-12"
                  >
                    {isDark ? (
                      <>
